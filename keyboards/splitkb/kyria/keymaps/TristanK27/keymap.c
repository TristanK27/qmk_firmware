 ...
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |  Shift |   Z  |   X  |   C  |   V  |   B  |  GUI |MDIA/home||MDIA/ESC|CW_TOGG| N|   M  |   ,  |   .  |   /  |  Shift |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |  spc |  end |  |  tab |  ent |      |      |      |
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |  F15   |  F9  |  F10 |  F11 |  F12 |  F18 |                              | NUM  |  7   |  8   |  9   |      |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 ...
 */
    [NUMB] = LAYOUT(
     KC_F15 , KC_F9, KC_F10, KC_F11,   KC_F12,   KC_F18 ,                                                    KC_NUM,   KC_7 ,  KC_8 ,   KC_9 ,  KC_TRNS , KC_TRNS,
...
*/
    [SYMB] = LAYOUT(
      KC_TRNS, S(KC_1), S(KC_2), S(KC_LBRC), S(KC_RBRC), KC_TRNS,                                       KC_TRNS, S(KC_7), S(KC_8), KC_TRNS, KC_TRNS, KC_TRNS,
 ...
 */
    [MDIA] = LAYOUT(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_LEFT), KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS, KC_MEDIA_PREV_TRACK, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, KC_MEDIA_NEXT_TRACK, KC_MPLY, KC_TRNS,
                                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |  SLEEP |RESET |Debug |RGBtog|RGBmod|RGBh+ |                              |RGBh- |RGBs+ |RGBs- |RGBv+ |RGBv- |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |                              |      |      |      |      |      |        |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |  POWER |      |      |      |      |      |      |      |  |      |      |      |      |      |      |      |        |
