...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  LALT_T(KC_DEL),          KC_Q,        KC_W,          KC_E,    KC_R,    KC_T,    KC_TRNS,             KC_TRNS,     KC_Y,    KC_U,    KC_I,    KC_O,              KC_P,           RALT_T(KC_BACKSLASH),
  ...
  LGUI(KC_LSFT), LCA(KC_LSFT),     LALT(KC_LSFT), KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, RALT(KC_RSFT), LCA(KC_RSFT), RGUI(KC_RSFT),
                                                           LGUI_T(KC_ESCAPE), KC_TRNS,                AC_TOGG, RGUI_T(KC_ESCAPE),
                                                                          KC_HOME,                 KC_PGUP,
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_TRNS,               KC_TRNS, KC_PLUS,    KC_MINUS,    KC_UNDERSCORE,    KC_TRNS, KC_TRNS,
